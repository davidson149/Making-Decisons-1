...
//CODE HERE
  var lovescode = true
if (lovescode === true || lovescode === false)  {
...
if (temperature === 55 && rain){
    console.log('one should wear a light rain jacket and bring an umbrella')
} else (temperature === 55 -rain);{
